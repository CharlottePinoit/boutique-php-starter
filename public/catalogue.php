                    ...
                    <div class="products-grid">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price">
                                    <span class="product-card__price-current"><?= $products[0]["price"] ?> €</span>
                                    <span class="product-card__price-old">139.99 €</span>
                                </div>
                                <p class="product-card__stock product-card__stock--low">⚠ Plus que <?= $products[1]["stock"] ?> </p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price">
                                    <span class="product-card__price-current"><?= $products[3]["price"] ?> €</span>
